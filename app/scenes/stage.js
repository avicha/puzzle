...
export default class Stage extends BaseScene {
    static getResources() {
        return [resources.menu_btn, resources.clock_thumb, resources.bird_thumb, resources.stage_empty, resources.star_full, resources.star_empty]
    }
    constructor(game) {
        super(game)
        this.enter()
        ...
        this.stage1_2 = this.addGameObject(new StageSelector(this.game.renderStageZone.pivot.x - 120, this.game.renderStageZone.pivot.y - 20, 1, { texture: resources.bird_thumb, shape: new Rectangle(0, 0, 240, 240), stage: '1-2', score: 1 }))
